...
const Index = () => {
  ...
  const { profileInfo, error, handleLoveCount, proError } =
  ...
  return (
    ...
    >
      {profileInfo !== 0 ? (
            ...
            <div className="flex justify-between w-full items-center flex-wrap gap-10 mt-20">
              ...
              <div className="text-center">
                ...
                <div className="flex justify-center items-center gap-2 mt-2">
                  <b className="text-2xl text-red-100">
                    {profileInfo.loveCount}
                  </b>
                  <GiSelfLove
        ...
        <h1 className="font-bold text-center text-yellow-400 bg-gray-800 p-4 shadow-md">
          I am working on adding home details. Please check back later!
        </h1>
      )}
    </div>
  );
